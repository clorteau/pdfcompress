...
try:
    from __init__ import __version__, res_dir
    from pdfcompressor import PDFCompressor
    from qhinttextcombobox import QHintTextComboBox
except ModuleNotFoundError:    
    from gs_pdf_compress import __version__, res_dir
    from gs_pdf_compress.pdfcompressor import PDFCompressor
    from gs_pdf_compress.qhinttextcombobox import QHintTextComboBox
...
class PDFCompressorUI(QWidget):
    iconPath = res_dir + "/icon.svg"

    def __init__(self):
        super().__init__()
        uic.loadUi(res_dir + "/pdfcompress-qt.ui", self)
